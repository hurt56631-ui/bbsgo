...
func InitDB() error {
	...
	db, err := gorm.Open(dialector, &gorm.Config{
		// Single SQL statements are already atomic in MySQL/SQLite. Disabling
		// GORM's implicit transaction removes one BEGIN/COMMIT round trip from
		// every simple insert/update; multi-statement business operations below
		// continue to use explicit transactions.
