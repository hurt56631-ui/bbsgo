...
var (
	...
	PermissionTopicAnnouncementCreate = PermissionDefinition{Type: TypeDashboard, Code: "dashboard.topic.announcement.create", GroupName: GroupContent, SortNo: 105, NameEn: "Publish Announcements", NameZh: "发布官方公告"}
...
var Permissions = []PermissionDefinition{
	...
	PermissionTopicView,
	PermissionTopicAnnouncementCreate,
